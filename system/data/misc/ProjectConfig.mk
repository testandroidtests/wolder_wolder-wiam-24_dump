...
CUSTOM_KERNEL_IMGSENSOR = s5k4h5yc_mipi_raw s5k5e2ya_mipi_raw
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5k4h5yc_mipi_raw
...
#MTK_BUILD_VERNO = alps-mp-m0.mp1-V2.34_aeon6580.we.m_P6
MTK_BWC_SUPPORT = yes
MTK_C2K_SUPPORT = no
...
BUILD_GMS=yes
BUILD_CUS=yes
#CREATE_PROJECT_INFO=20160225143328

# sanford.lin add 20160129 for aeon
include device/eastaeon/aeon6580_we_m/eastaeon.mk
#adupsfota start
...
##############Version Info#################
MTK_BUILD_VERNO = WIAM24_01_v1.0.4
AEON_SW_VERSION = MALATA-P507-N502C-Wolder-B18D-6580MV1.0.0
AEON_SW_VERSION_INCREMENTAL = B05	
##############Version Info#################
